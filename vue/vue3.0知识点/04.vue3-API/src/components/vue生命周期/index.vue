...
<script>
    ...
    export default {
        ...
        //  ，
        /***
         *  介于 beforeCreated 和 created 之间此时组件还没有初始化完成，
         *  可以进行数据请求
         *  
        */
        setup(){
            console.log('父组件的setup')
            /**
             *  组件挂载之前调用
             *  
            ...
            */
            onMounted(()=>{
                console.log(console.log('父组件 - onMounted'))
            })
            /**
             ...
             * 
            */
            onBeforeUpdate(()=>{ console.log('父组件 - onBeforeUpdated') })
            /**
             * 
             ...
             * 
            */
            onUpdated(()=>{ console.log('父组件 - onUpdated') })
            /**
            ...
            */
             ...
             * 
            */
            onActivated(()=>{ console.log('父组件 - onActivated') })
             /**
              * 
             *  用keep-alive包裹的组件
             *  移除Dom时被调用
             * 
            */
            onDeactivated(()=>{ console.log('父组件 - onDeactivated') })
            /**
             * 捕获后代组件传递的错误时调用
             * 
             *  捕获错误的来源
